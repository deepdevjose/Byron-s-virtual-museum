...
Formal result templates live in [`../benchmarks/performance-report.md`](../benchmarks/performance-report.md), with raw desktop and mobile JSON placeholders in `docs/benchmarks/`.
